...
Shader "Toony Colors Pro 2/User/Base_Shader"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(ver:"2.9.6";unity:"2021.3.23f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","SHADOW_COLOR_MAIN_DIR","SPECULAR_SHADER_FEATURE","RIM_SHADER_FEATURE","RIM","RIM_DIR_PERSP_CORRECTION","RIM_DIR","RIM_LIGHTMASK","OUTLINE_CLIP_SPACE","OUTLINE_CONSTANT_SIZE","OUTLINE_ZSMOOTH","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[,,,sp(name:"Ambient Intensity";imps:list[imp_constant(type:float;fprc:float;fv:0.6;f2v:(1, 1);f3v:(1, 1, 1);f4v:(1, 1, 1, 1);cv:RGBA(1, 1, 1, 1);guid:"dce3ed66-ea24-4503-aa7b-f6c7e6b8d368";op:Multiply;lbl:"Ambient Intensity";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,,,,,sp(name:"Rim Dir";imps:list[imp_mp_vector(def:(0, 0, 1, 0);fp:float;cc:3;chan:"XYZ";prop:"_RimDir";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"65d0b0a6-9552-43b7-a4a9-0c3a3df94256";op:Multiply;lbl:"Rim Direction";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 3b51aa3f73a702af1a130d025ef38b0a */
